namespace Splendor.Domain
{
    public class BuyDevelopment : GameAction
    {
        ...
        protected override string Description => $"Buys development ({Development.Prestige.ToString()})";

        public override Prestige PrestigeObtained => Development.Prestige + base.PrestigeObtained;
    }
}
