...
namespace Splendor.Forms
{
    public partial class NumericSelector : BaseUserControl
    {
        ...
        public int MinValue
        {
            ...
            set
            {
                if (value < currentValue)
                    throw new ArgumentOutOfRangeException($"Min value {value} can not be be a number lower than current value {currentValue}");
        ...
        public int MaxValue
        {
            ...
            {
                if (value > currentValue)
                    throw new ArgumentOutOfRangeException($"Max value {value} can not be be a number higher than current value {currentValue}");
